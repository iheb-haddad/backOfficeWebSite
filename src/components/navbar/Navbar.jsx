      ...
      <div className="navbar">
        ...
        <div className="navbarBody">
          <Link
            to="/"
            className={`navLine ${
              navLineClicked === "home" ? "navClicked" : "notClicked"
            }`}
          ...
          </Link>
          {
            <Link
              to="/Configurations"
              className={`navLine ${
                navLineClicked === "settings" ? "navClicked" : "notClicked"
              }`}
              onClick={props.clickSettings}
            >
              <FontAwesomeIcon icon={faGear} />
          ...
          <Link
            to="/GestionSources"
            className={`navLine ${
              navLineClicked === "sources" ? "navClicked" : "notClicked"
            }`}
          ...
          <Link
            to="/GestionDocuments"
            className={`navLine ${
              navLineClicked === "documents" ? "navClicked" : "notClicked"
            }`}
