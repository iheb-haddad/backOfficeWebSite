    ...
    Axios.put(`/users/password/${auth.user._id}`, {
      ...
      .catch((error) => {
        ...
        error.response.status === 401 &&
          setMsgErreur1("Mot de passe incorrect");
        error.response.status === 403 &&
          setMsgErreur2("vérifier la confirmation");
      });
  };
  ...
  return (
    <>
        ...
        <div className="passwordForm">
          ...
          <div className="passwordLine">
            ...
            <input
              ...
              style={{
                border:
                  emptyFileds && formData.newPassword === "" && "2px solid red",
              }}
            />
          </div>
          <div className="passwordLine">
      ...
      <div className="settingsButton">
        ...
        <button onClick={handleEnregistrer} className="enregistrer">
          Enregistrer
        </button>
      </div>
    </>
