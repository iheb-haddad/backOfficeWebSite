  ...
  useEffect(() => {
    ...
    .then((data) => {
        if(data.length !== 0){
          ...
          Axios.post('/auth/register', {newAdmin , 'confirmation' : 'flexiDocadmin123'})
            .then((data) => {
    ...
    const handleConnect = () => {
      ...
      .then((response) => {
        ...
        const encrypted_data = CryptoJS.AES.encrypt(JSON.stringify(stockedData), sekret_key).toString();
            ...
            <div className="bodyContainer">
              ...
              <div className="inputBox">
                    <div className="loginInput">
                            ...
                            style={{ border : emptyFileds && email === '' && '2px solid red'}}              
                            />
                    </div>
                    ...
                    <div className="loginInput">
                            ...
                            style={{ border : emptyFileds && password === '' && '2px solid red'}}
                            />
                    </div>
                    <div className="messageBox">
