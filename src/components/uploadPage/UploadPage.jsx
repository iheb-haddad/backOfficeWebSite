...
function UploadPage({ filesType, setDataChanged }) {
  ...
  const addSource = async (source, index) => {
    if (!source.name) {
      setMessage(
        "Manque le nom de la source à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
    ...
    if (!source.keywords) {
      setMessage(
        "Manque les mots clés de la source à la ligne " +
          (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!source.client) {
      setMessage("Manque du client à la ligne " + (index + indexError + 1));
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    try {
      ...
      setMessage(
        error.response.data.message + " à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
      return false;
  ...
  const addDocument = async (document, index) => {
    ...
    if (!document.title) {
      setMessage(
        "Manque le nom du document à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!document.language) {
      setMessage(
        "Manque la langue du document à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!document.urlDoc && document.display === "contenu") {
      setMessage(
        "Manque l'url du document à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!document.status) {
      setMessage(
        "Manque le statut du document à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (
      ...
      !document.expiration.split("T")[0].match(/^\d{4}-\d{2}-\d{2}$/)
    ) {
      setMessage(
        "format expiration à la ligne " +
          (index + indexError + 1) +
          " doit etre yyyy-mm-dd"
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    try {
      ...
      if (error.response.status === 403) {
        setMessage(
          "format expiration à la ligne " + (index + indexError + 1),
          +" doit etre yyyy-mm-dd"
        );
        setShowModal(true);
        setIndexError(index + indexError + 1);
  ...
  const addProject = async (project, index) => {
    if (!project.name) {
      setMessage(
        "Manque le nom du projet à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!project.description) {
      setMessage(
        "Manque la description du projet à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
  ...
  const addSubProject = async (subProject, index) => {
    if (!subProject.name) {
      setMessage(
        "Manque le nom du sous-projet à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!subProject.description) {
      setMessage(
        "Manque la description du sous-projet à la ligne " +
          (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
  ...
  const addSection = async (section, index) => {
    if (!section.titleFr) {
      setMessage(
        "Manque le titre de la section à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!section.titleEn) {
      setMessage(
        "Manque le titre de la section en anglais à la ligne " +
          (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
  ...
  const addUser = async (user, index) => {
    if (!user.email) {
      setMessage(
        "Manque l'email de l'utilisateur à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!user.password) {
      setMessage(
        "Manque le mot de passe de l'utilisateur à la ligne " +
          (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    if (!user.role) {
      setMessage(
        "Manque le role de l'utilisateur à la ligne " + (index + indexError + 1)
      );
      setShowModal(true);
      setIndexError(index + indexError + 1);
  ...
  const addError = async (document, index) => {
    if (!document.client) {
      setMessage("Manque du client à la ligne " + (index + indexError + 1));
      setShowModal(true);
      setIndexError(index + indexError + 1);
    ...
    try {
      const response = await Axios.post("/errors/upload", newDocument);
