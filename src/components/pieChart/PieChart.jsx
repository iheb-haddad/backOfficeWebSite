    ...
    <div className="flex col-span-3 gap-8">
      <div className="relative pt-4 p-2 flex flex-col gap-4">
        <FontAwesomeIcon
          ...
          onClick={handleReset}
        />
        <Labell className="text-sm">Client</Labell>
        <Select
          value={projectSelected}
          onValueChange={setProjectSelected}
          className="w-10"
        >
          <SelectTrigger
        ...
        <Select
          ...
          onValueChange={setSubProjectSelected}
        >
          <SelectTrigger
            className="ml-auto h-7 rounded-lg pl-2.5"
            aria-label="Select a value"
      ...
      <Card data-chart={id} className="flex flex-col flex-1">
        ...
        <CardHeader className="flex-row items-start space-y-0 pb-0">
          <CardTitle className="mr-2 text-sm">
            Nombre de consultation par document
          </CardTitle>
                  ...
                  >
                    <div className="flex items-center gap-2 text-xs">
                      <span
                        ...
                        style={{
                          backgroundColor:
                            data.length % 10 === 1 && index === data.length - 1
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {data[
                              activeIndex
                            ]?.consultationNumber.toLocaleString()}
                          </tspan>
                          <tspan
                            x={viewBox.cx}
                            y={(viewBox.cy || 0) + 24}
