...
function NormalPanel() {
  ...
  const filteredLngs = Object.keys(lngs).filter((lng) =>
    languages.some((lang) => lang.name === lngs[lng].nativeName)
  );
  ...
  useEffect(() => {
    ...
    function adjustPanelHeight() {
      ...
      normalPanel?.setAttribute(
        "style",
        `height: ${viewportHeight}px; overflow-y: auto;`
      );
    }
    adjustPanelHeight();
    ...
    <div style={{ display: liveConfiguration ? "flex" : "none" }}>
      <div className="panelContainer">
        ...
        <div
          ...
          style={{
            width: confSelected.panelWidth,
            backgroundColor: confSelected.panelColor,
          }}
        >
          <>
            <div
            ...
            >
              <div
                style={{
                  ...
                  color: confSelected.panelTextColor,
                  fontSize: "16px",
                  fontWeight: "bold",
                }}
              >
              ...
              <div className="buttonsEx">
                <select
                  ...
                  style={{
                    backgroundColor:
                      confSelected.backgroundLanguage || "#3B3B3B",
                    color: confSelected.textColorLanguage || "white",
                    fontSize: "13px",
                    padding: "3px",
                  }}
                >
              ...
              >
                <FontAwesomeIcon
                  icon={faX}
                  onClick={handleCloseLiveConfiguration}
                />
              </div>
            </div>
