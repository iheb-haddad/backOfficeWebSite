...
export default function SmtpConfig() {
    ...
    const confLines = [
        ...
        },
        {
            ...
            handle : (e) => setFormData({...formData, smtpPort: parseInt(e.target.value)}),
            holder : 'Saisir port',
        ...
        },
        {
            ...
            style : {borderColor: emptyFileds && !formData.smtpPassword ? 'red' : ''},
            options : []
        },
        {
            type : 'select',
    ...
    const handleEnregistrer = () => {
        const emptyFiled = formData.project === '' || formData.smtpHost === '' || formData.smtpPort === '' || formData.smtpLogin === '' || formData.smtpPassword === '' || formData.smtpType === ''
        setEmptyFileds(emptyFiled)
        if(!emptyFiled){
            if(oldSmtpConfig.smtpHost === formData.smtpHost && oldSmtpConfig.smtpPort === formData.smtpPort && oldSmtpConfig.smtpLogin === formData.smtpLogin && oldSmtpConfig.smtpPassword === formData.smtpPassword && oldSmtpConfig.smtpType === formData.smtpType){
